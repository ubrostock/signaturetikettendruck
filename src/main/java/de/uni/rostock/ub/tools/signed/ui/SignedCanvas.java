    ...
    public void paint(Graphics g) {
        if (svgdoc != null) {
            ...
            if ((float) bi.getWidth() / this.getWidth() >= (float) bi.getHeight() / this.getHeight()) {
                g.drawImage(bi, 0, 0, this.getWidth(), Math.round(this.getWidth() * bi.getHeight() / bi.getWidth()),
                    this);
            } else {
                g.drawImage(bi, 0, 0, Math.round(this.getHeight() * bi.getWidth() / bi.getHeight()), this.getHeight(),
                    this);
            }
        }
    }
